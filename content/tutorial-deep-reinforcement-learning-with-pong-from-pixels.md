...
**1.** First, you should install OpenAI Gym (using `pip install gym[atari,accept-rom-license]` - this package is currently not available on conda), and import NumPy, Gym and the necessary modules:
